...
export const MorgueChainOfCustodyManager: React.FC = () => {
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between border-b pb-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Morgue Cold Chamber & Chain of Custody Manager</h1>
            <p className="text-sm text-gray-500">Cold chamber slot allocation and medico-legal autopsy release documentation</p>
          </div>
        </div>
...
export default MorgueChainOfCustodyManager;
