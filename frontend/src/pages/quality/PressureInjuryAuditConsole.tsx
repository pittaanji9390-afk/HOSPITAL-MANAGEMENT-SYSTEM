...
export const PressureInjuryAuditConsole: React.FC = () => {
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between border-b pb-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Pressure Injury Staging & HAPI Prevention Console</h1>
            <p className="text-sm text-gray-500">Hospital-Acquired Pressure Injury staging, Q2H turn tracking and silicone dressings</p>
          </div>
        </div>
...
export default PressureInjuryAuditConsole;
