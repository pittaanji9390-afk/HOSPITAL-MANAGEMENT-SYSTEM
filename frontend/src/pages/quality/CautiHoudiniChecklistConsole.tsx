...
export const CautiHoudiniChecklistConsole: React.FC = () => {
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between border-b pb-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">CAUTI Prevention HOUDINI Catheter Removal Console</h1>
            <p className="text-sm text-gray-500">Evidence-based Foley indication verification and automated prompt removal steerer</p>
          </div>
        </div>
...
export default CautiHoudiniChecklistConsole;
