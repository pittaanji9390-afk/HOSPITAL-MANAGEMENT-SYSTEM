...
export const IvYSiteCompatibilityMatrixViewer: React.FC = () => {
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between border-b pb-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Parenteral IV Y-Site Physical Compatibility Matrix</h1>
            <p className="text-sm text-gray-500">Multi-infusion precipitation risk analyzer and dual-lumen catheter advisors</p>
          </div>
        </div>
...
export default IvYSiteCompatibilityMatrixViewer;
