...
export const RheumatologyJointMapTracker: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="bg-slate-900 text-white p-6 rounded-2xl border border-slate-800 shadow-xl flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Rheumatology 28-Joint DAS28 Homunculus & Biologic Tracker</h1>
